...
public class ArrayUtils {
	 ...
	 * 
	 * @param array
	 *            the array from which to take the subsection
	 * @param start
	 *            the index from which to start the subsection copy
	 * @param length
	 *            the length of the returned array.
	 * @return byte[] of length 'length', padded with zeros if array.length is
	 *         shorter than 'start' + 'length'
	 * 
	 *         NOTE! if start + length goes beyond the end of array.length, the
	 *         returned value will be padded with 0s.
	 */
	...
	/**
	 * Converts the input matrix into a single dimensional array by transposing
	 * and concatenating the columns
	 * 
	 * @param input
	 *            a 2D array whose columns will be concatenated
	...
	/**
	 * @param input1
	 *            array of bytes (possibly null)
	 * @param input2
	 *            array of bytes
	 * @return the concatenated array of bytes of length (input1.length +
	 *         input2.length)
	 */
	...
	/**
	 * @param sequence
	 *            the array of floats to return as a shifted and clipped array
	 *            of bytes
	 * @return byte[i] = sequence[i] * Constants.kFloatToByteShift cast to a
	 *         byte Note!: This doesn't handle cast/conversion issues, so don't
	 *         use this unless you understand the code
	 */
	...
	/**
	 * Boxes a byte array into an equal length Byte array.
	 * 
	 * @param bytes
	 *            an array of bytes.
	...
	/**
	 * Unboxes a Byte array to an equal length byte array.
	 * 
	 * @param byteObjs
	 *            an array of Bytes.
	 * @return an array of bytes.
	 */
	public static byte[] unbox(Byte[] byteObjs) {
